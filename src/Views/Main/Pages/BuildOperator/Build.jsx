    ...
    <div className="BodyContainer col-12 d-flex">
        <div className="col-4 d-flex flex-column p-3">
            ...
            <div>
                ...
                <p className='text-secondary mb-0 text-center' >Establish a compliant legal framework for your GCC.</p>
            </div>
        </div>
        <div className="col-4 d-flex flex-column p-3">
            <div style={{height:"100px"}}></div>
            ...
            <div>
                <h5 className='fw-bold text-center'>Workspace Design</h5>
                <p className='text-secondary mb-0 text-center'>Develop a functional and engaging workspace.</p>
            </div>
        </div>
        <div className="col-4 d-flex flex-column p-3">
            <div style={{height:"100px"}}></div>
            ...
            <div className=''>
                <h5 className='fw-bold text-center'>Leadership Hiring</h5>
                <p className='text-secondary mb-0 text-center '>Recruit experienced leaders and build a high-performing team.</p>
            </div>
        </div>
