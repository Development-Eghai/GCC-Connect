    ...
    <div className="BodyContainer col-12 d-flex">
        <div className="col-4 d-flex flex-column p-3">
            ...
            <div>
                ...
                <p className='text-secondary mb-0 text-center' >Create a roadmap aligned with your business objectives.</p>
            </div>
        </div>
        <div className="col-4 d-flex flex-column p-3">
            <div style={{height:"100px"}}></div>
            ...
            <div>
                <h5 className='fw-bold text-center'>Expert Recommendation</h5>
                <p className='text-secondary mb-0 text-center'>Leverage industry knowledge to guide your GCC setup</p>
            </div>
        </div>
        <div className="col-4 d-flex flex-column p-3">
            <div style={{height:"100px"}}></div>
            ...
            <div className=''>
                <h5 className='fw-bold text-center'>Project Plan</h5>
                <p className='text-secondary mb-0 text-center '>Define clear milestones and timelines for excecution</p>
            </div>
        </div>
