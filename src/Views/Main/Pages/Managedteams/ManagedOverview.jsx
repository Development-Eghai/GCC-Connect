      ...
      <div className="keyFeature col-12 d-flex">
        <div className="col-4 px-2">
          <div>
            ...
            <p className='text-secondary globaljustify mb-0 text-center'>Contract management, performance reviews, and resource allocation.</p>
          </div>
        </div>
        <div className="col-4 px-2">
          <div>
            ...
            <p className='text-secondary globaljustify mb-0 text-center'>Payroll, benefits, compliance, and tax management.</p>
          </div>
        </div>
        <div className="col-4 px-2">
          <div>
            ...
            <p className='text-secondary globaljustify mb-0 text-center'>Oversight of compliance, HR functions, and shared resources.</p>
          </div>
        </div>
      </div>
    </div>
